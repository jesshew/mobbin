...
export const SUPABASE_KEY = process.env.SUPABASE_ANON_KEY || console.warn('SUPABASE_KEY is not set in .env');
export const SUPABASE_BUCKET_NAME = process.env.SUPABASE_BUCKET_NAME || console.warn('SUPABASE_BUCKET_NAME is not set in .env');
export const MOON_DREAM_API_KEY = process.env.MOON_DREAM_API_KEY || console.warn('MOON_DREAM_API_KEY is not set in .env');