...
import { EXTRACTION_PROMPT_v1, EXTRACT_ELEMENTS_PROMPT,EXTRACTION_PROMPT_v2 } from '@/lib/prompt/prompts';
...
export async function extract_component_from_image(imageUrl) {
  ...
  const result = await callOpenAIVisionModel(EXTRACTION_PROMPT_v2, imageUrl);
