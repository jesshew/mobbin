...
export async function processAndSaveByCategory(screenshotId, imageBuffer, labelsDict, batchId) {
  ...
  try {
    ...
    console.log(`[Screenshot ${screenshotId}] Moondream processing complete. Total time: ${overallDuration.toFixed(2)/1000}s. Found ${componentResults.length} components.`);
